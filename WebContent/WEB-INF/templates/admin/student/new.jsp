...
<div class="modal-header">
	...
	<p class="modal-title small">Students added via admininistration interface are marked active by default</p>
</div>
<div class="modal-body">
	...
	<form class="form-student" action='${pageContext.request.contextPath}/admin/student/add' method="POST">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="form-group has-feedback" id="batch">
					<label class="control-label">Batch</label> <select class="form-control" tabindex=5 name="batch" required>
				...
				<div class="col-md-6">
					...
					<div class="form-group has-feedback" id="sem2">
						<label class="control-label">%age in 2nd semester</label> <input class="form-control" type="number" name="score" maxlength="5"
							value="${(student.score[1] != 0 || showZeroScore) && student.score[1] != -1 ? student.score[1] : null}" tabindex=11 required> <span id="sem2-ok"
					...
					<div class="form-group has-feedback" id="sem3">
						<label class="control-label">%age in 3rd semester</label> <input class="form-control" type="number" name="score" maxlength="5"
							value="${(student.score[2] != 0 || showZeroScore) && student.score[2] != -1 ? student.score[2] : null}" tabindex=12 required> <span id="sem3-ok"
					...
					<div class="form-group has-feedback" id="sem4">
						<label class="control-label">%age in 4th semester</label> <input class="form-control" type="number" name="score" maxlength="5"
							value="${(student.score[3] != 0 || showZeroScore) && student.score[3] != -1 ? student.score[3] : null}" tabindex=13 required> <span id="sem4-ok"
				...
				<div class="col-md-6">
					<div class="form-group has-feedback" id="sem5">
						<label class="control-label">%age in 5th semester</label> <input class="form-control" type="number" name="score" maxlength="5"
							value="${(student.score[4] != 0 || showZeroScore) && student.score[4] != -1 ? student.score[4] : null}" tabindex=14 required> <span id="sem5-ok"
					...
					<div class="form-group has-feedback" id="sem6">
						<label class="control-label">%age in 6th semester</label> <input class="form-control" type="number" name="score" maxlength="5"
							value="${(student.score[5] != 0 || showZeroScore) && student.score[5] != -1 ? student.score[5] : null}" tabindex=15 required> <span id="sem6-ok"
					...
					<div class="form-group has-feedback" id="sem7">
						<label class="control-label">%age in 7th semester</label> <input class="form-control" placeholder="Optional" type="number" name="score" maxlength="5" tabindex=16 id="inp-sem7"
							value="${fn:length(student.score) >= 7  && (student.score[6] != 0 || showZeroScore) && student.score[6] != -1 ? student.score[6] : null}"> <span id="sem7-ok"
					...
					<div class="form-group has-feedback" id="sem8">
						<label class="control-label">%age in 8th semester</label> <input class="form-control" placeholder="Optional" type="number" name="score" tabindex=17 maxlength="5" id="inp-sem8"
							value="${fn:length(student.score) == 8  && (student.score[7] != 0 || showZeroScore) && student.score[7] != -1 ? student.score[7] : null}"> <span id="sem8-ok"
